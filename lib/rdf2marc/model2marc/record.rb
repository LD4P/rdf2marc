    ...
    class Record
      ...
      def marc_record
        @marc_record ||= MARC::Record.new.tap do |marc_record|
          ...
          add_repeating_field(Field647, record_model.subject_access_fields.event_names, marc_record)
          add_repeating_field(Field650, record_model.subject_access_fields.topical_terms, marc_record)
          ...
          add_field(Field758, record_model.work, marc_record)
